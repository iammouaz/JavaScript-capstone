...
setTimeout(() => { Count.ActionCount('#Action', 'actionShow'); }, 1200);
setTimeout(() => { Count.ActionCount('#Horror', 'horrorShow'); }, 1200);
setTimeout(() => { Count.ActionCount('#Drama', 'showDrama'); }, 1200);
